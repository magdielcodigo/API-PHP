...
function route($route, $path_to_include){
  $tokenSys = 'asfdhajhbsjkdfagkeyuiwh873wa7823wgu';
  ...
  $server_root_url = ($_SERVER['REQUEST_URI'] == rp) ? '/' : str_replace(rp,'/',$server_uri);
  $request_url = filter_var($server_root_url, FILTER_SANITIZE_URL);
